...
function EditSupplier() {
  ...
  const fetchSupplier = async () => {
    try {
      const response = await axios.get(`${BACKEND_URL}/api/suppliers/getSupplierById/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.put(`${BACKEND_URL}/api/suppliers/updateSupplier/${id}`, formData);
  ...
  if (!user || initialLoading) {
    return <div className="createsupplier-loading">Loading supplier...</div>;
  }
